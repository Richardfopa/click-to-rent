...
public class PresentationMaconnerie extends AppCompatActivity implements PresentationPrestationAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_presentation_plomberie);
    ...
    public void EventChangeListener()
    {
        ...
        db.collection(getString(R.string.services))
                .whereEqualTo(getString(R.string.categorie), getString(R.string.maconnerie))
                        ...
                        for (DocumentChange dc : snapshots.getDocumentChanges()) {
                            switch (dc.getType()) {
                                case ADDED:
                                    ...
                                    maPresentationAdapteur.setOnItemClickListener(PresentationMaconnerie.this);
                                    break;
                                case MODIFIED:
