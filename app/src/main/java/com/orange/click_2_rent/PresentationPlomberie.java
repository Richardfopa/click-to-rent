...
public class PresentationPlomberie extends AppCompatActivity implements PresentationPrestationAdapter.OnItemClickListener {
    ...
    public void EventChangeListener()
    {
        ...
        db.collection(getString(R.string.services))
                .whereEqualTo(getString(R.string.categorie), getString(R.string.Plombrie))
                        ...
                        for (DocumentChange dc : snapshots.getDocumentChanges()) {
                            switch (dc.getType()) {
                                case ADDED:
                                    ...
                                    maPresentationAdapteur.setOnItemClickListener(PresentationPlomberie.this);
                                    break;
                                case MODIFIED:
