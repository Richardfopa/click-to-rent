...
public class PresentationInformatique extends AppCompatActivity implements PresentationPrestationAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_presentation_informatique);
    ...
    public void EventChangeListener()
    {
        ...
        db.collection(getString(R.string.services))
                .whereEqualTo(getString(R.string.categorie), getString(R.string.informatique))
                        ...
                        for (DocumentChange dc : snapshots.getDocumentChanges()) {
                            switch (dc.getType()) {
                                case ADDED:
                                    ...
                                    maPresentationAdapteur.setOnItemClickListener(PresentationInformatique.this);
                                    break;
                                case MODIFIED:
